...
parser.add_argument('--entropy_lambda', default=0.003, type=float, help='weighting of the entropy term in the loss')
...
args.output_dir = args.output_dir + '/batch_size_' + str(args.batch_size) + 'entropy_lambda_' + str(args.entropy_lambda)
...
graph_logger = Logger(
    name='QM9_batchszie_' + str(args.batch_size) + 'entropy_lambda_' + str(args.entropy_lambda) ,         # name of the logger
